  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative' }} className="noise">
      ...
      <section style={{
        ...
        {/* Waveform demo */}
<div style={{
  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, marginBottom: 44,
  padding: '16px 20px', background: 'var(--surface)',
  border: '1px solid var(--border)', borderRadius: 14,
  width: '100%', maxWidth: 480, overflow: 'hidden'
}}>
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    <div style={{ fontSize: 9, color: 'var(--muted)', marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 }}>Original</div>
    <WaveformIcon color="#6B8090" />
  </div>
  <div style={{ color: 'var(--muted)', fontSize: 13, flexShrink: 0, marginTop: 12 }}>to</div>
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    <div style={{ fontSize: 9, color: '#7FBDB5', marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 }}>Vocals</div>
    <WaveformIcon color="#7FBDB5" animated />
  </div>
  <div style={{ width: 1, height: 32, background: 'var(--border)', flexShrink: 0, marginTop: 12 }} />
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    <div style={{ fontSize: 9, color: '#F6D69B', marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 }}>Instrumental</div>
