  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative' }} className="noise">
      ...
      <section style={{
        ...
        {/* Waveform demo */}
<div style={{
  display: 'flex', alignItems: 'flex-end', gap: 8, marginBottom: 44,
  ...
  <div style={{ color: 'var(--muted)', fontSize: 13, paddingBottom: 8, flexShrink: 0 }}>to</div>
  <div style={{ display: 'flex', flexDirection: 'column' }}>
  ...
  <div style={{ width: 1, height: 28, background: 'var(--border)', flexShrink: 0, marginBottom: 4 }} />
  <div style={{ display: 'flex', flexDirection: 'column' }}>
